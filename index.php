    ...
    <nav class="navbar py-4 navbar-expand-lg ftco_navbar navbar-light bg-light flex-row">
    	<div class="container">
    		<div class="row no-gutters d-flex align-items-start align-items-center px-3 px-md-0">
    			<div class="col-lg-2 pr-4 align-items-center">
		    		<a class="navbar-brand" href="index.php">Health in <span>Motion</span></a>
	    		</div>
	    		<div class="col-lg-10 d-none d-md-block">
		    		<div class="row d-flex">
			    		<div class="col-md-4 pr-4 d-flex topper align-items-center">
			    			<div class="icon bg-white mr-2 d-flex justify-content-center align-items-center"><span class="icon-map"></span></div>
						    <span class="text">Menengai Road Upper Hill,
								Nairobi Kenya.</span>
					    </div>
					    <div class="col-md pr-4 d-flex topper align-items-center">
					    	<div class="icon bg-white mr-2 d-flex justify-content-center align-items-center"><span class="icon-paper-plane"></span></div>
						    <span class="text">Email: info@locum.com</span>
					    </div>
					    <div class="col-md pr-4 d-flex topper align-items-center">
					    	<div class="icon bg-white mr-2 d-flex justify-content-center align-items-center"><span class="icon-phone2"></span></div>
						    <span class="text">Phone: +254 722 982 976</span>
					    </div>
				    </div>
			    </div>
		    </div>
	  ...
	  <nav class="navbar navbar-expand-lg navbar-dark bg-dark ftco-navbar-light" id="ftco-navbar">
	    <div class="container d-flex align-items-center">
	      ...
	      <p class="button-custom order-lg-last mb-0"><a href="doctor/register.php" class="btn btn-secondary py-2 px-3">Log In</a></p>
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav mr-auto">
	        	<li class="nav-item active"><a href="index.php" class="nav-link pl-0">Home</a></li>
				<li class="nav-item  mr-lg-3 mt-lg-0 mt-3">
                            <a class="nav-link scroll" href="#about">about</a></li>
			...
			<div class="container">
	          ...
	          <div class="heading-section mb-5">
	          	<div class="pl-md-5 ml-md-5">
		          	<span class="subheading">About Health in Motion</span>
		            <h2 class="mb-4" style="font-size: 28px;">Digital Diagnostics anywhere</h2>
	            </div>
	          </div>
	          <div class="pl-md-5 ml-md-5 mb-5">
							<p>Health in Motion is a diagnostic service that lets doctors diagnose on the move by reviewing diagnostics from the hospitals and uploading them back for analysis.</p>
        ...
        <div class="row mb-5">
          <div class="col-md">
            <div class="ftco-footer-widget mb-5">
              <h2 class="ftco-heading-2 logo">HI<span>Motion</span></h2>
              <p>Health in Motion is a diagnostic web application that lets doctors diagnose on the move by reviewing diagnostics from the hospitals and uploading them back for analysis</p>
            </div>
            <div class="ftco-footer-widget mb-5">
            	<h2 class="ftco-heading-2">Have a Questions?</h2>
            	<div class="block-23 mb-3">
	              <ul>
	                <li><span class="icon icon-map-marker"></span><span class="text">Menengai Road Upper Hill,
Nairobi Kenya</span></li>
	                <li><a href="#"><span class="icon icon-phone"></span><span class="text">(+254) 722 982 976</span></a></li>
	                <li><a href="#"><span class="icon icon-envelope"></span><span class="text">info@locum.co.ke</span></a></li>
	              </ul>
	            </div>
          ...
          <div class="col-md">
            ...
            <div class="ftco-footer-widget mb-5 ml-md-4">
              <h2 class="ftco-heading-2">Diagnostic Services</h2>
              <ul class="list-unstyled">
  ...
  Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved |  <i  aria-hidden="true"></i> by <a href="https://github.com/" target="_blank">Fredrick Kalangi</a>
  </p>
          </div>
        </div>
      </div>
